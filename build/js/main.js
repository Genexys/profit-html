  ...
  if (blocksServices[0]) {
    ...
    for (const block of blocksServices) {
      ...
      const t = function (n) {
        ...
        function s() {
          if (new Date - i < o) {
            ...
            if (e.classList.contains(`list-service--two-row`)) {
              e.style.maxHeight = 277 === e.offsetHeight ? `277px` : t;
            } else {
              e.style.maxHeight = 140 === e.offsetHeight ? `140px` : t;
            }
          }
        }
        ...
        if (e.classList.contains(`list-service--two-row`)) {
          e.style.maxHeight = 277 === e.offsetHeight ? t : `277px`;
        } else {
          e.style.maxHeight = 140 === e.offsetHeight ? t : `140px`;
        }
      }
